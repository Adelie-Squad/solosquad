...
| 8 | Version Differences | v1.2.4 (npm 배포) vs 다음 릴리스 |
...
신규 test 53건; 728/728 pass. Migration `1.1.0 → 1.2.4` 멱등; 기존 사용자는 `owner_only: false` neutral upgrade.

전체 릴리스 노트: [CHANGELOG.md §1.2.4](CHANGELOG.md#122--2026-05-28).
...
현재 npm 릴리스: **v1.2.4** (npm registry: `1.2.4`).
