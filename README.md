...
| 8 | Version Differences | v1.2.0 (npm-published) vs upcoming releases |
...
## What's new in v1.2.0 (2026-05-28)
...
53 new tests; 728/728 pass. Migration `1.1.0 → 1.2.0` is idempotent; existing users land on `owner_only: false` for a neutral upgrade.

Full release notes: [CHANGELOG.md §1.2.0](CHANGELOG.md#120--2026-05-28).
...
Current npm release: **v1.2.0** (npm registry: `1.2.0`).
