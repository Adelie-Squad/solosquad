...
| 8 | Version Differences | v1.2.3 (npm-published) vs upcoming releases |
...
## What's new in v1.2.3 (2026-05-28)
...
53 new tests; 728/728 pass. Migration `1.1.0 → 1.2.3` is idempotent; existing users land on `owner_only: false` for a neutral upgrade.

Full release notes: [CHANGELOG.md §1.2.3](CHANGELOG.md#122--2026-05-28).
...
Current npm release: **v1.2.3** (npm registry: `1.2.3`).
