...
- 903 tests green (new `migration-v1.3.3-cron.test.ts`, `cron-schedule.test.ts`, `cron-lifecycle.test.ts`, `cron-runlog.test.ts`, `migration-1.2.9-to-1.3.2.test.ts`, `migration-registry-continuity.test.ts`). `validate-bundled` green.
