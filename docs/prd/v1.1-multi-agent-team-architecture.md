...
**문서 길이:** ~870 lines. *4 입력 source* (v1.x-workflow-goal-routine-evolution + Hermes V2 + Harness Report + HTML synthesis) 합성.
...
5. 4-docs 갱신 (product-roadmap · architecture · master-guide ko/en)
