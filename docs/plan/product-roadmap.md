...
| 버전 | 주제 | 비고 |
|---|---|---|
| **`v1.0.0`** ✓ 출시 (2026-05-21) | **정식 출시 (formal launch)** | `api-stability.md` 공개 약속 발효 + 42 CLI 명령 surface freeze + 진입 흐름 정합 2건 흡수 (`solosquad init` Step 1.5에 Claude login 흡수 + repo 등록 path-reference 단일화). 메신저는 Discord 단일, Slack은 post-v1.0 슬롯. 자세히 `docs/plan/v1.0-formal-launch.md` |
