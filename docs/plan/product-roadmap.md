...
| 버전 | 주제 | 문서 |
|---|---|---|
| `v1.1.0` ✓ | **Multi-Agent Team Architecture** — Chief / PM / 4 main / 20 specialist / 18 skill / 4 team. PRD §1-§20. 메신저는 v1.2 plan 으로 위임 | `docs/prd/v1.1-multi-agent-team-architecture.md` |
