...
| 버전 | 주제 | 문서 |
|---|---|---|
| `v0.3.x` | PM 모드 + 멀티 에이전트 오케스트레이션 | `docs/v0.3-pm-mode-orchestration.md` |
| `v0.4.x` | 밤새 자율 작업 완료 엔진 | `docs/v0.4-autonomous-engine.md` |
| `v0.5.x` | 워크플로우 메이커 (구 스킬 분석기 + 스킬 자유도 통합) | `docs/v0.5-workflow-maker.md` |
| `v0.6.x` | 디폴트 워크플로우 튜닝 (placeholder) | `docs/v0.6-default-workflow-tuning.md` |
...
- **v0.6**은 v0.3~v0.5 실전 데이터로 디폴트 워크플로우 4종을 튜닝하는 슬롯으로 재활용. 구체 범위는 v0.5 출시 4-6주 뒤 확정.
