...
> 이 문서는 **v0.0 (코어) + v0.1 (크로스 플랫폼) + v0.2.0 (레이아웃 재편 + 마이그레이션 프레임워크) + v0.2.1 (org/repo CLI + cross-repo 런타임)** 까지 구현 완료된 기능을 기술합니다. 미래 계획은 `docs/v1.X-*.md` 기획 문서를 참조하세요.
...
**구현 완료:**
- `docs/v0.1-cross-platform.md` — 크로스 플랫폼 (v0.1.x)
- `docs/v0.1.1-qa-hardening.md` — QA 하드닝
- `docs/v0.1.2-npm-publish.md` — npm 퍼블리시
- `docs/v0.2-safety-security.md` — 안전/보안
- `docs/v0.2.1-messenger-debugging.md` — 메신저 연결 디버깅 (v0.1.3~v0.1.5 hotfix)
- `docs/v0.2.2-terminology-layout.md` — GitHub-aligned 계층 재편 (npm v0.2.0 에 포함)
- `docs/v0.2.3-migration-process.md` — 범용 마이그레이션 프레임워크 (npm v0.2.0 에 포함)

**장기 로드맵:**
- `docs/v0.3-pm-mode-orchestration.md` — PM 모드 + 멀티 에이전트 오케스트레이션
- `docs/v0.4-autonomous-engine.md` — 자율 실행 엔진
- `docs/v0.5-workflow-maker.md` — 워크플로우 메이커 (구 스킬 분석기 + 스킬 자유도 통합)
- `docs/v0.6-default-workflow-tuning.md` — 디폴트 워크플로우 튜닝
- **v1.0** — 정식 출시 마일스톤 (v0.6까지 완료 후 minor bump)
- `docs/v1.1-dashboard-interaction.md` — 대시보드 상호작용 (대시보드 자체는 별도 리포지토리)
- `docs/v1.2-knowledge-ontology.md` — 사용자 지식·암묵지 온톨로지 + MCP 외부 연결

롤링 상태는 `docs/product-roadmap.md` 에서 관리.
...
- [autoresearch (Karpathy)](https://github.com/karpathy/autoresearch) — program.md 기반 자율 실행 (v0.3 참고)
