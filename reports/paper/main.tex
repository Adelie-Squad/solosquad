...
not solve the problem; regime-aware, multi-feature calibration is the indicated
next step. Pre-launch products without real labels (P1, P2) still require a small
real anchor (e.g., a fake-door test) to calibrate.
