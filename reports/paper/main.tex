...
uses. \textbf{(i) A calibrated screening feature} inside AI planning tools such as
SoloSquad~\citep{solosquad}: a cheap simulation shortlists ideas that a small real
fake-door test then confirms, cutting the cost of the first validation loop.
